...
def seed_users():
    ...
    isabella = User(username='isabella',first_name='Isabella', last_name='Costa', email='isabella@aa.io', password='password')

    natasha = User(username="Natasha", first_name="Natasha", last_name="Ivanova", email="natash@gmail.com", password="password")

    ethan = User(username="Ethan", first_name="Ethan", last_name="Smith", email="esmith@gmail.com", password="password")
...
def seed_likes():
    ...
    db.session.add_all([like1, like2, like3, like4, like5, like6, like7, like8, like9, like10, like11, like12, like13, like14])
