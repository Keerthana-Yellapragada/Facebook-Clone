...
def seed_posts():
    ...
    post1= Post(
        user_id=1,
        post_content="Went to the Bahamas over break! Had a great time there with my fam!",
    ...
    post2= Post(
        user_id=2,
        post_content="Visited the fam in Oregon over the holidays!",
    ...
    post3= Post(
        user_id=3,
        post_content="First Christmas Together!",
