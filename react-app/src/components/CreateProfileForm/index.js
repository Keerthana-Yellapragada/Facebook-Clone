        ...
        <div className="Outer-Form-Container">
            <div className="Inner-Form-Container">
                ...
                <form className="create-profile-form" onSubmit={submitHandler}>
                    ...
                    <div className="create-profile-user-info-container">
                        <div className='create-profile-user-profile-pic-container profile-user-profile-pic'>
                            <img
                        ...
                        <div className="create-profile-form-user-name-container">{user.first_name} {user.last_name}</div>
                    </div>
