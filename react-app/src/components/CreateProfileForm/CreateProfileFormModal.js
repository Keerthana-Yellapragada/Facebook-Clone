...
const NewProfileFormModal = ({userName}) => {
  ...
  return (
    <>
      ...
      <div className="modal-button create-profile-click-container" onClick={() => setShowModal(true)}>
        Profile
        {/* <img
                className='create-profile-modal-click-post-user-profile-pic'
                ...
                alt="user-profile-pics"
                                    />
        <div className="create-profile-modal-click-input">What's on your mind, {userName}? </div> */}
      </div>
